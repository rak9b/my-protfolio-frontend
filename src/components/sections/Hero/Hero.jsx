...
export default function Hero() {
  const words = [
    ...
    "JavaScript Developer & Creator of RoksJS",
    "Learning MARN Stack",
    "Linux & GitHub for DevOps Enthusiast",
    "Frontend Developer & Animation Lover",
    "Backend Developer & API Specialist",
    "Web Security & Bug Bounty Hunter",
    "Cloud Deployment & CI/CD Practitioner"
  ];
...
const profile = {
    ...
    skills: [
        'React', 'NextJS', 'JavaScript (ES6+)', 'Express',
        'MySQL', 'MongoDB', 'Docker', 'Prisma', 'TypeScript',
  ...
  useEffect(() => {
    ...
    const checkResolution = () => {
      ...
      setIsTargetResolution(isTarget);
    ...
    // Add CSS animation for grid and dots... (keep existing style logic if needed, but I'll optimize)
      ...
      <main className="bg-[#020617] text-white min-h-screen">
        ...
        >
          ...
          <div
            ...
            style={{
              paddingTop: isTargetResolution ? "12rem" : "",
            }}
          >
            ...
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0 animate__animated animate__fadeInLeft relative">
              ...
              <div className="relative mb-8 sm:mb-12 max-w-xl">
                <p className="text-base sm:text-xl text-gray-300/90 leading-relaxed">
                  JavaScript Developer⚡| React &amp; Next.js 🚀 | Creator of RoksJS 🛠️ | Passionate about secure development 💻✨
                </p>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 animate__animated animate__fadeInUp animate__delay-2s">
                ...
                {/* Contact Button */}
                <a
                  href="https://drive.google.com/drive/u/1/folders/1LNFHAPcoatYcimpwB_BvKkoy_u23TrGP"
                  target="_blank"
